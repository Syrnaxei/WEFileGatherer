...
export function PlayIcon({ size = 24 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="none">
      <path d="M7.608 4.615a.75.75 0 0 0-1.108.659v13.452a.75.75 0 0 0 1.108.659l12.362-6.726a.75.75 0 0 0 0-1.318L7.608 4.615ZM5 5.274c0-1.707 1.826-2.792 3.325-1.977l12.362 6.726c1.566.853 1.566 3.101 0 3.953L8.325 20.702C6.826 21.518 5 20.432 5 18.726V5.274Z" fill="currentColor" />
    </svg>
  );
}
...
export function PauseIcon({ size = 24 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="none">
      <path d="M5.746 3a1.75 1.75 0 0 0-1.75 1.75v14.5c0 .966.784 1.75 1.75 1.75h3.5a1.75 1.75 0 0 0 1.75-1.75V4.75A1.75 1.75 0 0 0 9.246 3h-3.5Zm-.25 1.75a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v14.5a.25.25 0 0 1-.25.25h-3.5a.25.25 0 0 1-.25-.25V4.75ZM14.746 3a1.75 1.75 0 0 0-1.75 1.75v14.5c0 .966.784 1.75 1.75 1.75h3.5a1.75 1.75 0 0 0 1.75-1.75V4.75A1.75 1.75 0 0 0 18.246 3h-3.5Zm-.25 1.75a.25.25 0 0 1 .25-.25h3.5a.25.25 0 0 1 .25.25v14.5a.25.25 0 0 1-.25.25h-3.5a.25.25 0 0 1-.25-.25V4.75Z" fill="currentColor" />
    </svg>
  );
}

/** @deprecated 使用 PauseIcon 替代 */
export const StopIcon = PauseIcon;

/** 文件夹 + 加号 — 加载按钮 */
export function FolderPlusIcon({ size = 24 }: { size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} fill="currentColor" stroke="none">
      <path d="M8.207 4c.46 0 .908.141 1.284.402l.156.12L12.022 6.5h5.728c.651 0 1.251.271 1.679.745.426.474.647 1.094.566 1.722L20 9v1.018a2.74 2.74 0 0 0-.686-.124l-.314-.017v-.877c0-.38-.282-.694-.648-.743L18.25 8.25h-5.729l-.397.329L10.195 10H8.707l.496-.413.052-.051L7.35 8.25H4.25a.75.75 0 0 0-.743.648L3.5 9v8.75c0 .38.282.694.648.743l.102.007h8.818c.182.287.396.547.637.777l.048.045H4.25a2.25 2.25 0 0 1-2.245-2.096L2 17.75v-11.5a2.25 2.25 0 0 1 2.096-2.245L4.25 4h3.957ZM17.5 12a1.75 1.75 0 0 1 1.744 1.606l.006.144v1.75h1.75a1.75 1.75 0 0 1 .144 3.494l-.144.006H19.25v1.75a1.75 1.75 0 0 1-3.494.144l-.006-.144V19.25h-1.75a1.75 1.75 0 0 1-.144-3.494l.144-.006h1.75v-1.75c0-.966.784-1.75 1.75-1.75Z" />
    </svg>
  );
}
